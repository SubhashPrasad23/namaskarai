...
export default function Footer() {
  ...
  return (
    <footer className="w-full">
      <div className="mx-auto w-full md:max-w-5/6 pb-5 md:pb-10 px-0 md:px-4 sm:px-6 lg:px-0">
        <div className="glass-card px-5 py-6 sm:px-6 md:rounded-2xl shadow-inner shadow-white backdrop-blur-sm z-50">
