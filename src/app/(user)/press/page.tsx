...
const faqs = [
  {
    q: "Do you support guest article collaborations?",
    a: "Yes. We welcome guest posts on AI learning, regional-language AI adoption, and practical use cases for Assam audiences. Reach out with your topic idea.",
  },
  {
    q: "Do you do podcast or YouTube interviews?",
    a: "Yes. We are open to podcast and YouTube interviews focused on AI literacy in Assam, beginner AI workflows, and regional-language AI tools.",
  },
  {
    q: "What does your media kit include?",
    a: "Platform overview, audience focus, priority topics, quote workflow, and contact channels.",
  },
];
      ...
      <section className="mx-auto w-full md:max-w-5/6 px-4 sm:px-8 md:px-8 lg:px-4">
        ...
        <div className="glass-video-card mb-8">
          <div className="p-5! glass-video-card">
            <h1 className=" mb-1 text-xl sm:text-2xl font-bold text-red-600">
              Press & Collaboration
            </h1>
            <p className="text-gray-600 text-sm max-w-3xl">
              Practical collaborations with media, podcasts, YouTube channels,
              and education partners to expand AI literacy in Assam.
            </p>
          </div>
        </div>
          ...
          <div className="glass-apple-liquid">
            <div className="glass-apple-liquid-inner p-5 sm:p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-bold text-red-500">Focus</h3>
              </div>
              <p className="text-xs text-gray-600">
                Assamese plus English practical AI learning for students,
          ...
          <div className="glass-apple-liquid">
            <div className="glass-apple-liquid-inner p-5 sm:p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-bold text-red-500">Media Use</h3>
              </div>
              <p className="text-xs text-gray-600">
                Regional AI adoption, beginner workflows, and Assam-specific
          ...
          <div className="glass-apple-liquid">
            <div className="glass-apple-liquid-inner p-5 sm:p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-bold text-red-500">Format</h3>
              </div>
              <p className="text-xs text-gray-600">
        ...
        <div className="glass-video-card mb-8">
          <div className="glass-video-card p-5!">
            <h2 className="text-base font-bold text-red-500 mb-4">
              Priority Topics
            </h2>
            <ul className="space-y-3">
              {priorityTopics.map((topic, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="mt-1.5 w-2 h-2 rounded-full bg-gray-800 shrink-0" />
          ...
          <div className="glass-video-card p-5!">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {guestPostIdeas.map((idea, i) => (
                <div key={i} className="glass-video-card p-4!">
        ...
        <div className="glass-video-card mb-8">
          <div className="glass-video-card p-5!">
            <h2 className="text-base font-bold mb-4">Quote Request Workflow</h2>
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="border-t border-gray-200/60">
                ...
                >
                  ...
                  {openFaq === i ? (
                    <ChevronUp className="md:h-5 md:w-5 h-4 w-4 text-gray-500 shrink-0" />
                  ) : (
                    <ChevronDown className="md:h-5 md:w-5 h-4 w-4 text-gray-500 shrink-0" />
                  )}
                </button>
                <AnimatePresence>
                  {openFaq === i && (
                    ...
                    >
                      <p className="md:text-sm text-xs text-slate-600 pb-4 glass-apple-liquid-inner">
                        {faq.a}
                      </p>
                    </motion.div>
                  )}
        ...
        <div className="glass-video-card">
          <div className=" p-5 flex items-center gap-3 flex-wrap">
            <a
              ...
              className="inline-flex items-center gap-2 bg-red-500 text-white text-sm font-semibold px-5 py-2.5 rounded-lg hover:scale-[1.02] transition-colors"
            >
              hello@namaskar.ai
            </a>
            <a
              ...
              className="inline-flex items-center gap-2 border border-gray-300 rounded-lg text-sm font-medium px-4 py-2 transition-colors"
            >
              Instagram
            </a>
          </div>
